...
export declare const getMenuOptions: <T extends unknown>(options: MenuOptions<T>) => (number | MenuOptionObject<T> | ((...items: string[]) => number) | ((...items: MenuOptionObject<T>[]) => number) | {
