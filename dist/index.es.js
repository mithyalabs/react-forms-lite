...
var FieldArrayInner = /*#__PURE__*/function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return component ? reactExports.createElement(component, props) : render ? render(props) : children // children come last, always called
    ? typeof children === 'function' ? children(props) : !isEmptyChildren(children) ? reactExports.Children.only(children) : null : null;
  };
...
const MLFormContent = (props) => {
    ...
    const [formSchema, setFormSchema] = reactExports.useState(schema);
    reactExports.useEffect(() => {
