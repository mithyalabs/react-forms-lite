...
var Checkbox = function (props) {
    ...
    return React.createElement(
        ...
        updatedProps.options &&
            React.createElement(
                'div',
                { className: updatedProps.className, id: updatedProps.id },
                updatedProps.options.map(function (option) {
                    return typeof option === 'string'
                        ? React.createElement(
                              'div',
                              { key: option, style: { display: 'flex', alignItems: 'center' } },
                        ...
                        : React.createElement(
                              'div',
                              { key: option.name, style: { display: 'flex', alignItems: 'center' } },
                              React.createElement('input', {
                                  type: 'checkbox',
                                  name: updatedProps.name,
                                  onChange: formikProps.handleChange,
...
var PlainText = function (props) {
    var _a = props.fieldProps,
        fieldProps = _a === void 0 ? {} : _a;
    var _b = fieldProps.text,
        text = _b === void 0 ? '' : _b;
...
var Select = function (props) {
    ...
    return React__default.createElement(
        'div',
        { style: { display: 'flex', flexDirection: fieldProps.labelOrientation == 'landscape' ? 'row' : 'column' } },
...
var TextField = function (props) {
    var _a = props.fieldProps,
        fieldProps = _a === void 0 ? {} : _a,
        _b = props.formikProps,
        formikProps = _b === void 0 ? {} : _b;
    var updatedProps = __assign(__assign({}, fieldProps), {
        onChange: formikProps.handleChange,
        onBlur: formikProps.handleBlur,
...
var BuildFormRow = function (props) {
    ...
    return React.createElement(
        'div',
        { style: rowStyle },
        map(colItems, function (item, index) {
            ...
            if (!componentConfig) return React.createElement('div', { key: rowId + '_field_' + index });
            var conditionalProps = getConditionalProps(item, formikProps);
            var fieldProps = __assign(
                __assign(
                    __assign(
                        { id: item.id, name: item.name || item.valueKey, labelOrientation: settings.labelOrientation || 'portrait' },
            ...
            if (conditionalProps.hidden === true) return React.createElement('div', { key: rowId + '_field_' + index });
            return React.createElement(
                'div',
                {
...
var getUpdateSchema = function (schema, formId) {
    return map(schema, function (schemaItem) {
        if (isArray(schemaItem)) {
            return map(schemaItem, function (item) {
                return __assign(__assign({}, item), { id: formId + '_' + uniqueId() });
            });
        }
...
var MLFormContent = function (props) {
    ...
    return React.createElement(
        React.Fragment,
        null,
        map(formSchema, function (configRow, index) {
...
var ReactForm = function (props) {
    var config = props.config,
        formId = props.formId,
        _a = props.initialValues,
        initialValues = _a === void 0 ? {} : _a,
        onSubmit = props.onSubmit,
        formSettings = props.formSettings,
        _b = props.isInProgress,
        isInProgress = _b === void 0 ? false : _b,
        _c = props.isReadOnly,
        isReadOnly = _c === void 0 ? false : _c,
        formikProps = __rest(props, ['config', 'formId', 'initialValues', 'onSubmit', 'formSettings', 'isInProgress', 'isReadOnly']);
    return React.createElement(Formik, __assign({ initialValues: initialValues, onSubmit: onSubmit }, formikProps), function (formProps) {
        return React.createElement(MLFormBuilder, {
            schema: config,
            formId: formId,
            settings: __assign(__assign({}, formSettings), { isReadOnly: isReadOnly }),
